...
/// </summary>
public class GetReceivedContactRequestsTests
{
    ...
    public GetReceivedContactRequestsTests()
    {
    ...
    // Condition: status lọc ngoài 0..2.
    // Confirmation: 400.
    [Theory]
    [InlineData(-1)]
    [InlineData(3)]
    ...
    // Condition: danh sách rỗng từ repo.
    // Confirmation: 200, data đếm 0, requests rỗng.
    [Fact]
    ...
    // Condition: 1 request pending, có parent; lọc status=0.
    // Confirmation: map parent, canReview=true, gọi repo với (nannyId, 0).
    [Fact]
    ...
    // Condition: request đã chấp nhận.
