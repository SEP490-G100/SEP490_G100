...
public class UpdateChildProfileTests
{
    ...
    public UpdateChildProfileTests()
    {
    ...
    // Condition: ChildAgeGroup không hợp lệ.
    [Fact]
    ...
    // Condition: Ghi chú vượt quá 1000 ký tự.
    [Fact]
    public async Task NotesTooLong_Throws()
    {
        ...
        Assert.Equal("Ghi chú không được vượt quá 1000 ký tự.", ex.Message);
    }

    // Condition: không có ParentProfile cho user.
    [Fact]
    ...
    // Condition: con không tồn tại / không thuộc hồ sơ phụ huynh này.
    [Fact]
    ...
    // Condition: cập nhật thành công; ghi SaveChanges, DTO ánh xạ entity sau khi gán.
    [Fact]
