...
/// </summary>
public class DeleteChildProfileTests
{
    ...
    private const string ChildNotFoundMessage = "KhÃ´ng tÃ¬m tháº¥y con.";
    ...
    public DeleteChildProfileTests()
    {
    ...
    // Condition: không có ParentProfile.
    [Fact]
    ...
    // Condition: hồ sơ con không tồn tại dưới quyền phụ huynh.
    [Fact]
    ...
    // Condition: xóa mềm — IsDeleted, Update, SaveChanges.
    [Fact]
