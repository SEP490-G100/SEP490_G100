...
builder.Services.AddScoped<ModeratorVerificationRepository>();
builder.Services.AddScoped<ModeratorAccountRepository>();
builder.Services.AddScoped<ModeratorJobRepository>();
builder.Services.AddScoped<AdminAccountRepository>();
builder.Services.AddScoped<AdminNotificationRepository>();
builder.Services.AddScoped<AdminSubcriptionPlanRepository>();
...
builder.Services.AddScoped<ModeratorVerificationService>();
builder.Services.AddScoped<ModeratorAccountService>();
builder.Services.AddScoped<ModeratorJobService>();
builder.Services.AddScoped<AdminAccountService>();
builder.Services.AddScoped<AdminNotificationService>();
builder.Services.AddScoped<AdminSubcriptionPlanService>();
builder.Services.AddScoped<AdminDashboardService>();
builder.Services.AddScoped<ModeratorDashboardService>();
