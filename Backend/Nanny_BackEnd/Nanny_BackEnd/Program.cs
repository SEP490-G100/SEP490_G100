...
builder.Services.AddScoped<IModeratorVerificationRepository, ModeratorVerificationRepository>();
builder.Services.AddScoped<IModeratorAccountRepository, ModeratorAccountRepository>();
builder.Services.AddScoped<IModeratorJobRepository, ModeratorJobRepository>();
builder.Services.AddScoped<IAdminAccountRepository, AdminAccountRepository>();
builder.Services.AddScoped<IAdminNotificationRepository, AdminNotificationRepository>();
builder.Services.AddScoped<IAdminSubcriptionPlanRepository, AdminSubcriptionPlanRepository>();
...
builder.Services.AddScoped<IModeratorDashboardRepository, ModeratorDashboardRepository>();
...
builder.Services.AddScoped<IModeratorVerificationService, ModeratorVerificationService>();
builder.Services.AddScoped<IModeratorAccountService, ModeratorAccountService>();
builder.Services.AddScoped<IModeratorJobService, ModeratorJobService>();
builder.Services.AddScoped<IAdminAccountService, AdminAccountService>();
builder.Services.AddScoped<IAdminNotificationService, AdminNotificationService>();
builder.Services.AddScoped<IAdminSubcriptionPlanService, AdminSubcriptionPlanService>();
builder.Services.AddScoped<IAdminDashboardService, AdminDashboardService>();
builder.Services.AddScoped<IModeratorDashboardService, ModeratorDashboardService>();
